...
const Index = () => {
  ...
  const createNotification = () => {
    ...
    axios.post('https://notificationservice-rcfpsxcera-uc.a.run.app/api2/api2/create-notification/', {
  ...
  useEffect(() => {
    ...
    axios.get('https://notificationservice-rcfpsxcera-uc.a.run.app/api2/api2/get-user-ids/')
      .then(response => {
