...
const AccountActivity = () => {
  ...
  const createImmediateNotification = () => {
    ...
    axios.post('https://notificationservice-rcfpsxcera-uc.a.run.app/accountactivityapi/create-account-activity/', {
      email_id: 'user@example.com',
      message: 'This is an account activity just for you!',
      immediate: true,  // Immediate notification
    }, {
      headers: {
  ...
  const createDelayedNotification = () => {
    ...
    axios.post('http://notificationservice-rcfpsxcera-uc.a.run.app/accountactivityapi/create-account-activity/', {
      email_id: 'user@example.com',
      message: 'This is an account activity just for you!',
      immediate: false,  // Delayed notification
    }, {
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  useEffect(() => {
    ...
    axios.get('https://notificationservice-rcfpsxcera-uc.a.run.app/accountactivityapi/get-account-activity-user-ids/')
      .then(response => {
