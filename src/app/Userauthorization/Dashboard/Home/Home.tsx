  ...
  const accountTypeOptions: AccountTypeOption[] = adminCMSData
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        setAddNewFiatWallet(false);
        setTimeout(() => {
          setShowSuccessPage(false);  // Hide success page
          setFiatDropdownVisible(true); // Show Fiat dropdown
        }, 5000);
        resetForm();
        ...
        <div className={styles.backdrop}>
          <div className={styles.modalContentSuccess}>
            <div className={styles.successPage}>
              ...
              <svg width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="custom-wallet-icon">
              <g clip-path="url(#clip0_1532_9597)">
              <path d="M66.3798 52.4995C65.5518 52.5035 64.8838 53.1755 64.8838 54.0035C64.8838 54.8315 65.5558 55.5035 66.3838 55.4995C67.2118 55.4995 67.8838 54.8275 67.8838 53.9995C67.8838 53.1715 67.2118 52.4995 66.3798 52.4995" stroke="url(#paint0_linear_1532_9597)" stroke-width="3.625" stroke-linecap="round" stroke-linejoin="round"/>
